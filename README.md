...
1. Запишіть екран: `/start` → інформація → лікар → прайс → запис → нагадування (можна змінити дату візиту на «завтра» для тесту)
2. Опублікуйте репозиторій на GitHub
3. Надішліть посилання + відео
